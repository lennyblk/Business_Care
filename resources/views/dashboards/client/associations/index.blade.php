        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="lead">Business Care vous permet de soutenir des associations et de participer à des actions solidaires.</p>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">{{ Str::limit($association['description'], 100) }}</p>
                                        <p class="card-text"><small class="text-muted">Domaine: {{ $association['domain'] }}</small></p>
                                    </div>
                                    <div class="card-footer bg-white">
                                        <a href="{{ route('client.associations.show', $association['id']) }}" class="btn btn-primary btn-sm">Voir les détails</a>
                                    </div>
                                </div>
                            </div>
                        @empty
