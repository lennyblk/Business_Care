                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1</td>
                                            <td class="text-end">{{ number_format($invoice->amount * 0.8, 2, ',', ' ') }} €</td>
                                            <td class="text-end">{{ number_format($invoice->amount * 0.8, 2, ',', ' ') }} €</td>
                                        </tr>
                                        <tr>
                                            <td>Services inclus</td>
                                            <td>1</td>
                                            <td class="text-end">{{ number_format($invoice->amount * 0.2, 2, ',', ' ') }} €</td>
                                            <td class="text-end">{{ number_format($invoice->amount * 0.2, 2, ',', ' ') }} €</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end fw-bold">{{ number_format($invoice->amount * 1.2, 2, ',', ' ') }} €</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">{{ number_format($invoice->amount * 1.2, 2, ',', ' ') }} €</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
