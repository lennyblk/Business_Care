...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-4 font-weight-bold">Mode de paiement préféré:</div>
                <div class="col-md-8">{{ $company->mode_paiement_prefere }}</div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4 font-weight-bold">Nombre d'employés:</div>
                <div class="col-md-8">{{ $company->employee_count }}</div>
            </div>
